...
/**
 * @author Jonathan Kenny This class is a demonstration of some of the most
 *         basic features of class.
 */
public class PersonXxXBasicClassDemo {
  ...
  // * Initial weight
  // */
  // public PersonXxXBasicClassDemo(String startName, int startAge,
  // int startHeight, int startWeight) {
  //
  // name = startName;
  // age = startAge;
  // height = startHeight;
  ...
  // PersonXxXBasicClassDemo person1 = new PersonXxXBasicClassDemo(startName,
  // startAge, startHeight, startWeight);
  //
  // person1.setName("Jon");
